---
name: steward-setup
description: Set up a project steward via interactive interview. Use when the operator wants to create a steward for this project, write docs/trunk/STEWARD.md, or connect the project to a swarm with a steward standard operating procedure.
allowed-tools: Bash(ve --help:*), Bash(cat:*), Bash(ve board channels:*), Bash(ve board send:*)
---

<!-- Chunk: docs/chunks/plugin_orch_commands - Static plugin port of steward-setup -->
<!-- Chunk: docs/chunks/leader_board_steward_skills - Steward skill templates -->
<!-- Chunk: docs/chunks/steward_setup_bootstrap - Board.toml auto-suggest defaults and bootstrap channel messages -->
<!-- Chunk: docs/chunks/steward_deploy_step - Conditional DO deploy step in autonomous behavior -->
