---
name: chunk-review
description: Review chunk implementation for alignment with documented intent, producing an APPROVE, FEEDBACK, or ESCALATE decision. Use when the operator asks to review a chunk, before completing implemented work, or as the REVIEW phase of the chunk lifecycle.
...
<!-- Chunk: docs/chunks/reviewer_decision_tool - Requires ReviewDecision tool calls for explicit decision recording -->
