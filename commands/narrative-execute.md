---
name: narrative-execute
description: Execute a narrative's proposed chunks in dependency order, running parallel subagents wave by wave through the full chunk lifecycle. Use when the operator asks to execute or run a narrative, or to drive a multi-chunk initiative to completion.
