...
description: Investigate and resolve a stuck orchestrator work unit. Use when a chunk is in NEEDS_ATTENTION, a background chunk failed or stalled, a merge from an orch/ branch did not land, or the operator asks why orchestrator work is not progressing.
