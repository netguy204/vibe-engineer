...
4. **Clean up stale chunk backreferences:** If you encounter `# Chunk:` comments in the
   source code, remove them. Chunks are archived after completion and these references
   are no longer useful. Subsystem backreferences (`# Subsystem:`) should be preserved.
