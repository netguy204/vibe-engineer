...
2. **Parallel refinement**: Spawn sub-agents to refine each GOAL.md simultaneously
...
Work units enter NEEDS_ATTENTION status when they require operator input. Check the attention queue:
