...
bug_type: null
depends_on: []
created_after: ["artifact_manager_base", "cli_exit_codes", "cli_help_text", "cli_task_context_dedup", "frontmatter_io", "integrity_subsystem_bidir", "orch_cli_extract", "orch_daemon_stale_files", "orch_merge_safety", "orch_state_transactions"]
---
