...
code_references:
  - ref: src/entities.py#Entities::startup_payload
    implements: "Core startup/wake payload assembly — loads identity, core memories, wiki index and maintenance protocol (wiki entities only), consolidated index, touch protocol, and SOP section (wiki entities only)"
