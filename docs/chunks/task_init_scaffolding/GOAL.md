...
code_references:
  ...
  - ref: src/task_init.py#TaskInit::_render_agents_md
    implements: "Renders task AGENTS.md template to task root (with CLAUDE.md symlink)"
  - ref: src/task_init.py#TaskInit::_render_skills
    implements: "Renders skill templates to .agents/skills/ with task context (with .claude/commands/ symlinks)"
  ...
  - ref: src/templates/task/AGENTS.md.jinja2
    implements: "Task-specific AGENTS.md template with project list and orientation"
