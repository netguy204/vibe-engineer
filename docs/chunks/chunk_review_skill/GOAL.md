...
friction_entries: []
bug_type: null
depends_on: ["reviewer_infrastructure"]
created_after: ["explicit_deps_command_prompts", "chunk_list_flags", "progressive_disclosure_external", "progressive_disclosure_refactor", "progressive_disclosure_validate"]
---
