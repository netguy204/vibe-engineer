...
- prompt: Subsystem schemas and data model
  chunk_directory: subsystem_schemas_and_model
- prompt: Subsystem directory structure and CLI scaffolding
  chunk_directory: subsystem_cli_scaffolding
- prompt: Subsystem OVERVIEW.md template
  chunk_directory: subsystem_template
- prompt: Chunk-subsystem bidirectional references
  chunk_directory: bidirectional_refs
- prompt: Subsystem status transitions
  chunk_directory: subsystem_status_transitions
- prompt: Agent discovery command
  chunk_directory: agent_discovery_command
- prompt: Specification and documentation updates
  chunk_directory: spec_docs_update
- prompt: Subsystem impact resolution during chunk completion
  chunk_directory: subsystem_impact_resolution
created_after:
- cross_repo_chunks
---
