...
proposed_chunks: []
chunks:
- chunk_id: orch_foundation
  relationship: implements
- chunk_id: orch_scheduling
  relationship: implements
- chunk_id: orch_dashboard
  relationship: implements
- chunk_id: orch_attention_queue
  relationship: implements
- chunk_id: orch_attention_reason
  relationship: implements
- chunk_id: orch_blocked_lifecycle
  relationship: implements
- chunk_id: orch_broadcast_invariant
  relationship: implements
- chunk_id: orch_conflict_oracle
  relationship: implements
- chunk_id: orch_conflict_template_fix
  relationship: implements
- chunk_id: orch_activate_on_inject
  relationship: implements
- chunk_id: orch_agent_question_tool
  relationship: implements
- chunk_id: orch_agent_skills
  relationship: implements
- chunk_id: orch_question_forward
  relationship: implements
- chunk_id: orch_sandbox_enforcement
  relationship: implements
- chunk_id: orch_mechanical_commit
  relationship: implements
- chunk_id: orch_tcp_port
  relationship: implements
- chunk_id: orch_verify_active
  relationship: implements
- chunk_id: orch_inject_validate
  relationship: implements
- chunk_id: orch_inject_path_compat
  relationship: implements
- chunk_id: orch_submit_future_cmd
  relationship: implements
- chunk_id: deferred_worktree_creation
  relationship: implements
code_references:
...
[SYNTHESIZED] Enable parallel execution of chunk work across multiple AI agents by
