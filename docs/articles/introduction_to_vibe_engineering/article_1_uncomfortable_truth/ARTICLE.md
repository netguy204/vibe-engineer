...
*This article was written before the current workflow was established. The outline below is reconstructed from the original planning.*

1. ~~Opening hook~~ — amnesiac surgeon metaphor
2. ~~Series introduction~~ — what is Vibe Engineering
3. ~~The first vibe~~ — magic of 95% success
4. ~~The pain~~ — context overflow, session amnesia
5. ~~Junior parallel~~ — we've seen this before
6. ~~The insight~~ — onboarding exercise, multiple times a day
7. ~~What works~~ — progressive, intent-capturing, documented, guardrailed
8. ~~The puzzle~~ — how to onboard without career change
9. ~~Graybeard truth~~ — value is judgment, not typing
10. ~~Bootstrap context~~ — CLAUDE.md as HR packet
11. ~~Compounding judgment~~ — documentation improvements propagate
12. ~~Historical parallel~~ — string concatenation, tools absorbing problems
13. ~~Toolmaking~~ — Cantrill's insight
14. ~~What I'm building~~ — rich onboarding environment
15. ~~The stakes~~ — same models, different outcomes
16. ~~Series tease~~ — the journey ahead
...
*Ideas cut from this article are in the series-level parking lot in SERIES.md.*
